...
function openDevTools() {
  api.toggleDevTools().catch(e => console.error('toggleDevTools failed:', e))
}
  ...
  <div class="settings">
    ...
    <div class="about">
      ...
      <p>
        ...
        <span class="github-link" style="margin-left: 12px;" @click="openDevTools">{{ $t('settings.button.devTools') }}</span>
      </p>
    </div>
  </div>
